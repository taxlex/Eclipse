...
public class MenuBarBuilder implements Observer {
	...
	public void update(Observable arg0, Object arg1){
		...
		assemble.setEnabled(view.getCurrentState().getLoadFileActive());
		assemble.setEnabled(view.getCurrentState().getStepActive());
		assemble.setEnabled(view.getCurrentState().getChangeJobActive());
	}
}
